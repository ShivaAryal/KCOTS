                ...
                <ScrollView contentContainerStyle={styles.modalBackground} keyboardShouldPersistTaps="handled" >
                    <View style={{backgroundColor:'#fff',padding:10,borderRadius:10}}>
                        <View style={{flexDirection:'row',justifyContent:'space-between'}}> 
                            <Text style={{fontSize:20,marginLeft:10,marginVertical:5}}>Add Bhush Stock</Text>
                            <FAB
                                icon="close"
                                color="#fff"
                        ...
                        <Picker
                            ...
                            mode="dropdown">
                            <Picker.Item value="Masino Bhush" label="Masino Bhush" />
                            <Picker.Item value="Moto Bhush" label="Moto Bhush" />
                        </Picker>
